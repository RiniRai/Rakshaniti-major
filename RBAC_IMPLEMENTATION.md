...
This document describes the Role-Based Access Control (RBAC) system implemented across the Rakshaniti application. RBAC ensures that only authorized users can access specific features and perform certain actions based on their assigned roles.
