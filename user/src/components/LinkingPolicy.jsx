  ...
  const linkingTypes = [
    {
      ...
      description: "Links from Rakshaniti to external websites",
      color: "bg-blue-500"
    },
    {
      type: "Inbound Links", 
  icon: <Link2 className="w-6 h-6" />,
      description: "Links from external websites to Rakshaniti",
      color: "bg-green-500"
    },
    {
      type: "Deep Links",
  icon: <Globe className="w-6 h-6" />,
      description: "Direct links to specific pages within Rakshaniti",
      color: "bg-orange-500"
    },
    {
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 mb-8 transition-colors duration-500">
          ...
          <div className="prose prose-lg max-w-none text-gray-700 dark:text-gray-300">
            <p className="mb-4">
              ...
              Rakshaniti maintains strict guidelines for linking to and from external websites. 
            ...
            <div className="bg-blue-50 dark:bg-blue-900/30 border-l-4 border-blue-400 p-4 rounded">
              <p className="text-sm text-blue-800 dark:text-blue-200">
                ...
                API integrations, and digital connections associated with the Rakshaniti platform.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="p-8">
            ...
            <div className="mt-8 bg-gray-50 dark:bg-gray-700 rounded-lg p-6 transition-colors duration-500">
              ...
              <p className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
                ...
                Rakshaniti does not endorse, control, or assume responsibility for the content, 
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              <div>
                ...
                <ul className="space-y-2 text-gray-600 dark:text-gray-400 text-sm">
                  ...
                  <li>• Must not misrepresent Rakshaniti's purpose</li>
              ...
              <div>
                ...
                <ul className="space-y-3 text-gray-700 dark:text-gray-300">
                  ...
                  <li className="flex items-start">
                    <XCircle className="w-5 h-5 text-red-500 mt-0.5 mr-3 flex-shrink-0" />
                    Framing Rakshaniti within another website
                  </li>
                  <li className="flex items-start">
                    <XCircle className="w-5 h-5 text-red-500 mt-0.5 mr-3 flex-shrink-0" />
                ...
                <div className="bg-orange-50 dark:bg-orange-900/30 border border-orange-200 dark:border-orange-700 rounded-lg p-4 mt-6 transition-colors duration-500">
                  ...
                  <p className="text-orange-700 dark:text-orange-300 text-sm">
                    ...
                    obtain written permission before linking to Rakshaniti.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <div className="space-y-2 text-blue-100">
                <p>Email: links@Rakshaniti.gov.in</p>
            ...
            <div>
              ...
              <div className="space-y-2 text-blue-100">
                <p>Security Issues: security@Rakshaniti.gov.in</p>
                <p>Content Concerns: content@Rakshaniti.gov.in</p>
