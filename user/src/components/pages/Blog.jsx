...
const SAMPLE_POSTS_EN = [
  {
    ...
    title: 'How to apply for a Rakshaniti scheme',
    date: 'October 10, 2025',
    tags: ['Guides', 'Schemes'],
    excerpt:
      'A short guide that walks you through the steps required to apply for a scheme on Rakshaniti. Learn what documents you need and common pitfalls to avoid.',
    content:
  ...
  {
    id: 2,
    slug: 'making-most-of-Rakshaniti',
    title: 'Making the most of Rakshaniti: tips & tricks',
    date: 'September 3, 2025',
    tags: ['Tips', 'Platform'],
    excerpt:
      'Shortcuts and best practices to get the most value from Rakshaniti — from notifications to profile settings and quick search tricks.',
    content:
...
const SAMPLE_POSTS_HI = [
  {
    id: 1,
    slug: 'how-to-apply-for-scheme',
    title: 'Rakshaniti योजना के लिए कैसे आवेदन करें',
    date: '10 अक्टूबर, 2025',
    tags: ['मार्गदर्शिका', 'योजनाएँ'],
    excerpt:
      'यह छोटा मार्गदर्शक आपको Rakshaniti पर योजना के लिए आवेदन करने के चरणों से परिचित कराता है — किन दस्तावेज़ों की आवश्यकता है और सामान्य गलतियाँ।',
    content:
  ...
  },
  {
    id: 2,
    slug: 'making-most-of-Rakshaniti',
    title: 'Rakshaniti का बेहतर उपयोग: टिप्स और ट्रिक्स',
    date: '3 सितंबर, 2025',
    tags: ['टिप्स', 'प्लेटफ़ॉर्म'],
    excerpt:
      'नोटिफिकेशन से लेकर प्रोफ़ाइल सेटिंग्स तक छोटे-छोटे सुझाव ताकि आप Rakshaniti का अधिकतम लाभ उठा सकें।',
    content:
