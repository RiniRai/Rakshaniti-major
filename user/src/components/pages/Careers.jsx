...
const JOBS = [
  ...
  },
  {
    ...
    posted: 'Oct 12, 2025',
    description:
      'Work with Gram Panchayats to implement and maintain Rakshaniti at the village level. Provide on-site technical support, run training sessions for local staff, and help with data uploads and reporting.',
    hiDescription:
      'ग्राम पंचायतों के साथ मिलकर गांव स्तर पर Rakshaniti को लागू और मेंटेन करें। ऑन-साइट तकनीकी सहायता प्रदान करें, स्थानीय स्टाफ के लिए प्रशिक्षण आयोजित करें, और डेटा अपलोड व रिपोर्टिंग में मदद करें।',
  },
  {
    id: 'j5',
  ...
  },
  {
    ...
    posted: 'Oct 1, 2025',
    description:
      'Engage with villagers to raise awareness about schemes, assist residents in using Rakshaniti, collect feedback and help with paperless application support.',
    hiDescription:
      'योजनाओं के बारे में जागरूकता बढ़ाने के लिए ग्रामीणों से जुड़ें, Rakshaniti के उपयोग में निवासियों की मदद करें, प्रतिक्रिया एकत्र करें और पेपरलेस आवेदन सहायता प्रदान करें।',
  },
  {
    id: 'j7',
  ...
  },
  {
    ...
    posted: 'Sep 15, 2025',
    description:
      'Work with government stakeholders to coordinate rollout of specific schemes via Rakshaniti, monitor KPIs and ensure smooth inter-departmental collaboration.',
    hiDescription:
      'सरकार के हितधारकों के साथ काम करके Rakshaniti के माध्यम से विशिष्ट योजनाओं का रोलआउट समन्वयित करें, KPIs मॉनिटर करें और विभागों के बीच सुचारू सहयोग सुनिश्चित करें।',
  },
  {
    id: 'j9',
...
export default function Careers() {
  ...
  const strings = useMemo(() => ({
    en: {
      title: 'Careers',
      subtitle: 'Join Rakshaniti — build products that make access to public schemes easier for everyone.',
    ...
    hi: {
      title: 'करियर',
      subtitle: 'Rakshaniti से जुड़ें — सार्वजनिक योजनाओं तक पहुँच सरल बनाने के लिए उत्पाद बनाएँ।',
