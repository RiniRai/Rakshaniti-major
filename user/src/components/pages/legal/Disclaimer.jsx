...
export default function Disclaimer() {
  ...
  const TEXT = {
    en: {
      title: 'Disclaimer',
      subtitle: 'Important information about the content on Rakshaniti',
      sections: [
        { id: 'accuracy', title: 'Accuracy', body: 'The content on Rakshaniti is provided for general informational purposes. While we try to keep information current, we do not guarantee its completeness or accuracy.' },
        ...
        { id: 'links', title: 'External links', body: 'Rakshaniti may link to external sites. We are not responsible for the content, practices, or privacy policies of those sites.' },
        ...
        { id: 'liability', title: 'Limitation of liability', body: 'To the fullest extent permitted by law, Rakshaniti and its contributors are not liable for any damages resulting from use of the site.' },
      ],
  // contact removed per request
    },
    hi: {
      title: 'अस्वीकरण',
      subtitle: 'Rakshaniti पर सामग्री के बारे में महत्वपूर्ण जानकारी',
      sections: [
        { id: 'accuracy', title: 'सटीकता', body: 'Rakshaniti पर दी गई जानकारी केवल सामान्य प्रयोजनों के लिए है। हम जानकारी की पूर्णता या सटीकता की गारंटी नहीं देते।' },
        ...
        { id: 'links', title: 'बाहरी लिंक', body: 'Rakshaniti बाहरी साइटों के लिंक रख सकता है। हम उन साइटों की सामग्री, प्रथाओं या गोपनीयता नीतियों के लिए उत्तरदायी नहीं हैं।' },
        ...
        { id: 'liability', title: 'दायित्व की सीमा', body: 'कानून द्वारा अनुमति की अधिकतम सीमा तक, Rakshaniti और इसके योगदानकर्ता साइट के उपयोग से होने वाले किसी भी नुकसान के लिए उत्तरदायी नहीं होंगे।' },
      ],
  // contact removed per request
    },
  };
