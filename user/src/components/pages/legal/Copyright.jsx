...
export default function Copyright() {
  ...
  const TEXT = {
    en: {
      ...
      subtitle: 'Ownership, permissions and reporting on Rakshaniti',
      sections: [
        {
          id: 'ownership',
          title: 'Ownership of content',
          body: 'All original content on Rakshaniti (text, images, logos, code, and designs) is owned or licensed by Rakshaniti unless otherwise stated. Unauthorized reproduction is prohibited.'
        },
        {
          id: 'license',
          title: 'Limited license to users',
          body: 'Subject to these terms, Rakshaniti grants you a limited, non-exclusive, non-transferable license to access and use the site for personal, non-commercial purposes.'
        },
        {
          id: 'user-submissions',
          title: 'User submissions & grants',
          body: 'By submitting content (comments, documents, or uploads) you grant Rakshaniti a worldwide, royalty-free, perpetual license to use, reproduce, and display the content as necessary to provide the service.'
        },
        {
          id: 'dmca',
        ...
        },
        {
          ...
          body: 'For copyright concerns, contact our legal team at legal@Rakshaniti.example (replace with the real address) with the details requested in our DMCA procedure.'
        },
      ],
    },
    hi: {
      title: 'कॉपीराइट नोटिस',
      subtitle: 'Rakshaniti पर अधिकार, अनुमतियाँ और रिपोर्टिंग',
      sections: [
        {
          id: 'ownership',
          title: 'सामग्री का स्वामित्व',
          body: 'Rakshaniti पर सभी मूल सामग्री (पाठ, छवियाँ, लोगो, कोड और डिज़ाइन) Rakshaniti के स्वामित्व वाली या लाइसेंस प्राप्त हैं जब तक कि अन्यथा कहा न गया हो। अनधिकृत पुनरुत्पादन निषिद्ध है।'
        },
        {
          id: 'license',
          title: 'उपयोगकर्ताओं को सीमित लाइसेंस',
          body: 'इन शर्तों के अधीन, Rakshaniti आपको व्यक्तिगत, गैर-व्यावसायिक उद्देश्यों के लिए साइट तक पहुँच और उपयोग करने के लिए एक सीमित, गैर-विशेष, अस्थायी लाइसेंस प्रदान करता है।'
        },
        {
          id: 'user-submissions',
          title: 'उपयोगकर्ता प्रस्तुतियाँ और ग्रांट्स',
          body: 'सामग्री (टिप्पणियाँ, दस्तावेज़ या अपलोड) सबमिट करके आप Rakshaniti को आपकी सामग्री को सेवा प्रदान करने के लिए उपयोग, पुनरुत्पादन और दिखाने के लिए एक विश्वव्यापी, रॉयल्टी-रहित, स्थायी लाइसेंस प्रदान करते हैं।'
        },
        {
          id: 'dmca',
        ...
        },
        {
          ...
          body: 'कॉपीराइट समस्याओं के लिए हमारी लीगल टीम से legal@Rakshaniti.example पर संपर्क करें (इसे वास्तविक पते से बदलें) और DMCA प्रक्रिया में अनुरोधित विवरण भेजें।'
        },
      ],
    },
  };
