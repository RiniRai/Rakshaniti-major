...
export default function Terms() {
  ...
  const t = useMemo(() => ({
    en: {
      ...
      subtitle: 'Please read these terms carefully before using Rakshaniti.',
    ...
    hi: {
      ...
      subtitle: 'Rakshaniti का उपयोग करने से पहले कृपया इन शर्तों को ध्यान से पढ़ें।',
  ...
  const SECTIONS = useMemo(() => ({
    en: [
      { id: 'intro', title: 'Introduction', body: `Welcome to Rakshaniti. These Terms govern your use of our website and services. By using Rakshaniti, you agree to these Terms.` },
      { id: 'use', title: 'Using the Service', body: `Rakshaniti provides scheme information, application help and community features. Use the service responsibly.` },
      ...
      { id: 'contact', title: 'Contact', body: `Contact support@Rakshaniti.example for questions.` },
    ],
    hi: [
      { id: 'intro', title: 'परिचय', body: `Rakshaniti में आपका स्वागत है। ये शर्तें हमारी वेबसाइट और सेवाओं के उपयोग को नियंत्रित करती हैं।` },
      { id: 'use', title: 'सेवा का उपयोग', body: `Rakshaniti योजना जानकारी, आवेदन सहायता और सामुदायिक सुविधाएँ प्रदान करता है। सेवा का सावधानीपूर्वक उपयोग करें।` },
      ...
      { id: 'contact', title: 'संपर्क', body: `प्रश्नों के लिए support@Rakshaniti.example पर संपर्क करें।` },
    ]
  }), []);
