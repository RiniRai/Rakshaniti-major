        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h2 
              ...
              data-tooltip-content="Rakshaniti helps PRIs enhance transparency and digital governance."
            >
              Our Mission
            </h2>
            <Tooltip
            ...
            <p className='leading-relaxed max-w-prose'>
              To strengthen e-Governance in Panchayati Raj Institutions (<span data-tooltip-id="pri-tooltip" data-tooltip-content="PRIs: Panchayati Raj Institutions, local self-government bodies in villages.">PRIs</span>) across the country, the Ministry of Panchayati Raj (MoPR) has launched Rakshaniti, a user-friendly web-based portal. Rakshaniti aims to bring in better transparency in decentralised planning, progress reporting, and work-based accounting.
            </p>
            <Tooltip
              id="pri-tooltip"
              place="top"
          ...
          <div className='relative'>
            <img
              ...
              data-tooltip-content="Rakshaniti provides a unified digital platform for governance."
            />
            <Tooltip
