...
const FAQ_LIST = [
  ...
  { id: 'q4', q: 'How can Gram Panchayat officials use Rakshaniti?', a: `Panchayat staff can register as institutional users, manage village-level data, upload reports, and monitor scheme progress in the dashboard. For on-site training, contact your district coordinator.`, hiQ: 'ग्राम पंचायत अधिकारी Rakshaniti का कैसे उपयोग कर सकते हैं?', hiA: `पंचायत स्टाफ संस्थागत उपयोगकर्ता के रूप में पंजीकरण कर सकते हैं, गांव-स्तरीय डेटा प्रबंधित कर सकते हैं, रिपोर्ट अपलोड कर सकते हैं और डैशबोर्ड में योजना की प्रगति मॉनिटर कर सकते हैं। ऑन-साइट प्रशिक्षण के लिए अपने जिला समन्वयक से संपर्क करें।`, category: 'Panchayat' },
...
export default function Faq() {
  ...
  const strings = useMemo(() => ({
    en: {
      title: 'FAQ',
      subtitle: 'Find answers, guides, and contact options to help you use Rakshaniti.',
    ...
    hi: {
      title: 'FAQ',
      subtitle: 'Rakshaniti का उपयोग करने में सहायता के लिए उत्तर, मार्गदर्शिकाएँ और संपर्क विकल्प खोजें।',
