...
const SAMPLE = {
  ...
  events: [
    ...
    { id: 'e2', title: 'Webinar: Using Rakshaniti for outreach', date: '2025-11-03', location: 'Online' },
  ],
  testimonials: [
    { id: 'p1', name: 'Ramesh Kumar', role: 'Panchayat Secretary', quote: 'Rakshaniti helped our panchayat streamline scheme reports and reach more beneficiaries.' },
