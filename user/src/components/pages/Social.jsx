...
const SAMPLE_POSTS = [
  { id: 'p1', author: 'Rakshaniti', text: 'We launched a new FAQ page to help you find schemes faster. Check it out!', time: '2h', likes: 12, comments: 3, tags: ['#announcement'] },
...
export default function Social() {
  ...
  const strings = useMemo(() => ({
    en: {
      title: 'Social Media',
      subtitle: 'Follow Rakshaniti, share experiences and connect with the community.',
    ...
    hi: {
      title: 'सोशल मीडिया',
      subtitle: 'Rakshaniti को फॉलो करें, अनुभव साझा करें और समुदाय से जुड़ें।',
  ...
  function shareUrl(url) {
    if (navigator.share) navigator.share({ title: 'Rakshaniti', url }).catch(() => window.open(url, '_blank'));
