...
const FAQS_EN = [
  {
    question: "What is Rakshaniti?",
    answer:
      "Rakshaniti is a Government of India initiative to help citizens explore, discover, and apply for government schemes that match their needs. It uses a simplified process to provide scheme information, eligibility details, and direct application options.",
  },
  {
    question: "Who can use Rakshaniti?",
    answer:
      "Any citizen of India can use Rakshaniti. The portal is designed for individuals, families, farmers, students, and small business owners who wish to find and apply for relevant government schemes.",
  },
  {
  ...
  {
    question: "Is there any fee to use Rakshaniti?",
    answer:
      "No. Rakshaniti is a free service provided by the Government of India. You should never pay anyone for accessing the portal or applying through it.",
  },
];

const FAQS_HI = [
  {
    question: "Rakshaniti क्या है?",
    answer:
      "Rakshaniti एक सरकारी पहल है जो नागरिकों को उनकी जरूरतों के अनुसार सरकारी योजनाएँ खोजने, समझने और उनके लिए आवेदन करने में मदद करती है। यह योजना जानकारी, पात्रता विवरण और सीधे आवेदन विकल्प प्रदान करता है।",
  },
  {
    question: "Rakshaniti कौन इस्तेमाल कर सकता है?",
    answer:
      "भारत का कोई भी नागरिक Rakshaniti का उपयोग कर सकता है। यह पोर्टल व्यक्तियों, परिवारों, किसानों, छात्रों और लघु व्यवसाय मालिकों के लिए डिज़ाइन किया गया है।",
  },
  {
  ...
  {
    question: "क्या Rakshaniti का उपयोग करने के लिए कोई शुल्क है?",
    answer: "नहीं। Rakshaniti एक मुफ्त सेवा है।",
  },
];
    ...
    <div className="bg-[#fdfaf6] dark:bg-gray-900 min-h-screen transition-colors duration-300">
      ...
      >
        ...
        <div className="relative text-center">
          <h1 className="text-5xl font-extrabold text-white jost tracking-wider">{lang === 'hi' ? 'पूछे जाने वाले प्रश्न' : 'FAQs - Rakshaniti'}</h1>
