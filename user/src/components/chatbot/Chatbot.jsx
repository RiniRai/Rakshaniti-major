...
`
  ...
  {
    triggers: ["about Rakshaniti", "mission", "objective", "what is Rakshaniti", "about portal"],
    response: `
<div>
  <p><strong>Our Mission:</strong></p>
  <p>To strengthen e-Governance in Panchayati Raj Institutions (PRIs) across the country, the Ministry of Panchayati Raj (MoPR) has launched Rakshaniti, a user-friendly web-based portal. Rakshaniti aims to bring in better transparency in decentralised planning, progress reporting, and work-based accounting.</p>
  ...
  <p><strong>About Rakshaniti:</strong> Our Objective is to provide an easy-to-use, transparent system for citizens and PRIs to manage applications and services digitally.</p>
</div>
`,
  },
  {
...
`
  ...
  {
    triggers: ["about Rakshaniti", "mission", "objective", "what is Rakshaniti", "about portal", "सरलसेवा के बारे में", "उद्देश्य"],
    response: `
<div>
  <p><strong>हमारा मिशन:</strong></p>
  <p>देश भर में पंचायती राज संस्थानों (PRIs) में ई-गवर्नेंस को मजबूत करने के लिए, पंचायती राज मंत्रालय (MoPR) ने Rakshaniti लॉन्च किया है, एक उपयोगकर्ता-अनुकूल वेब-आधारित पोर्टल। Rakshaniti का उद्देश्य विकेंद्रीकृत योजना, प्रगति रिपोर्टिंग और कार्य-आधारित लेखांकन में बेहतर पारदर्शिता लाना है।</p>
  ...
  <p><strong>Rakshaniti के बारे में:</strong> हमारा उद्देश्य नागरिकों और PRIs के लिए आवेदनों और सेवाओं को डिजिटल रूप से प्रबंधित करने के लिए एक उपयोग में आसान, पारदर्शी प्रणाली प्रदान करना है।</p>
</div>
`,
  },
  {
